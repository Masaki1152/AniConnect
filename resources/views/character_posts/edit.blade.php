                    ...
                    <form
                        ...
                        <div class="title">
                            ...
                            <input type="text" name="character_post[post_title]" placeholder="タイトル"
                                value="{{ old('character_post.post_title', $character_post->post_title) }}"
                            ...
                            <p class="title__error text-sm text-red-500 mt-1">
                                {{ $errors->first('character_post.post_title') }}</p>
                        </div>
                        <div class="star_num">
                            ...
                            <select name="character_post[star_num]"
                                ...
                                @foreach ($numbers as $num => $star)
                                    <option value="{{ $num }}"
                                        @if ($character_post->star_num == $num) selected @endif>
                                        {{ $star }}
                                    </option>
                                @endforeach
                            </select>
                                ...
                                <div id="custom-multi-select-list" class="max-h-48 overflow-y-auto">
                                    @php
                                        ...
                                        $selectedCategories = old(
                                            'character_post.categories_array',
                                            $existingCategories,
                                        );
                                    @endphp
