                    ...
                    <form
                        ...
                        <div class="title">
                            ...
                            <p class="title__error text-sm text-red-500 mt-1">
                                {{ $errors->first('work_story_post.post_title') }}
                            </p>
                        </div>
                        <div class="star_num">
                            ...
                            <select name="work_story_post[star_num]"
                                ...
                                @foreach ($numbers as $num => $star)
                                    <option value="{{ $num }}"
                                        @if (old('work_story_post.star_num') == $num) selected @endif>
                                        {{ $star }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div id="custom-multi-select-container" class="category relative">
                            ...
                            <div id="custom-multi-select" tabindex="0" class="w-1/3">
                                <div id="custom-multi-select-list" class="max-h-48 overflow-y-auto">
                                    @php
                                        $selectedCategories = old('work_story_post.categories_array', []);
                                    @endphp
                        ...
                        <div class="body">
                            ...
                            <textarea name="work_story_post[body]" placeholder="内容を記入してください。"
                                ...
                                data-max-length="4000" data-counter-id="bodyCharacterCount" oninput="countCharacter(this)">{{ old('work_story_post.body') }}</textarea>
                            <p id="bodyCharacterCount" class="mt-1 text-sm text-gray-500"></p>
                            <p class="text-sm text-red-500 mt-1">{{ $errors->first('work_story_post.body') }}</p>
                        </div>
                        <div class="image">
