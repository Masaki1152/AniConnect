    ...
    <div class="container mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="flex flex-col md:flex-row gap-4">
                    <div class="left_block flex-1">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <a href="{{ route('users.show', ['user_id' => $operate->id]) }}" class="font-medium">
                                    {{ $perate->name }}
                                </a>
                    ...
                    <div class='like flex items-center gap-2'>
                        ...
                        <div class="like_user">
                            <a href="{{ route('notification_like.index', ['notification_id' => $notification->id]) }}"
                                ...
                                <p id="like_count">{{ $notification->users->count() }}件
                                </p>
                            </a>
                        </div>
                    </div>
        ...
        <div class="text-lg font-semibold">
            「<span class="text-blue-500">{{ $notification->title }}</span>」へのコメント：<span
                id='comment_count'>{{ count($notification->workReviewComments) }}</span>件
            </p>
        </div>
